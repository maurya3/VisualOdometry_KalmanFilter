...
#groundTruth = genfromtxt('/home/deepak/Desktop/KALmanfilter/kalman_filter/groundTruth.csv', delimiter=',',skip_header=1)

#Observations: position_X, position_Y
measurmens = genfromtxt('/home/deepak/Desktop/KALmanfilter/kalman_filter/measurmens.csv', delimiter=',',skip_header=1)


#Checking our result with OpenCV
#opencvKalmanOutput = genfromtxt('/home/deepak/Desktop/KALmanfilter/kalman_filter/kalmanv.csv', delimiter=',',skip_header=1)
